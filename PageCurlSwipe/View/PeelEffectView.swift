            ...
            .overlay(content: {
                GeometryReader {
                    ...
                    Rectangle()
                        .fill(.black)
                    /*
                     - When we added the vertical padding of 10 to the delete view, you can see that the backdrop shadow is greater than it is in the delete view.
                     - Keep in mind that adding padding vertically by 10 will not fix the issue; since the shadow radius is 15, we must also take that into account and padding vertically by a total of 25 (15 + 10) instead.
                     */
                        .padding(.vertical, 25)
                     ...
                     */
                        .overlay(alignment: .trailing) {
                            Rectangle()
                                .fill(
                                    .linearGradient(
                                        colors: [.clear, .white, .clear, .clear],
                                        startPoint: .leading,
                                        endPoint: .trailing)
                                )
                                .frame(width: 60)
